...
if uploaded_file is not None:
    ...
    try:
        ...
        def evaluate_model(name, y_true, y_pred, n_features):
            ...
            st.subheader(f"{name} Evaluation Results")
        ...
        # --- Model Selection ---
        model_choice = st.selectbox("🔧 Choose a model to train:", ["Random Forest", "SVM"])
        ...
        if st.button(" Train and Evaluate"):
            if model_choice == "Random Forest":
                ...
                model = SVR(
                    kernel='rbf',
                    C=11.789142699330444,
                    gamma='scale',
                    epsilon=0.025714592843367128
                )
